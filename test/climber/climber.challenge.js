...
describe("[Challenge] Climber", function () {
  let deployer, proposer, sweeper, hacker;
  ...
  before(async function () {
    ...
    [deployer, proposer, sweeper, hacker] = await ethers.getSigners();
  ...
  after(async function () {
    ...
    expect(await token.balanceOf(hacker.address)).to.eq(VAULT_TOKEN_BALANCE);
  });
});
